...
with tab2:
    ...
    with d2:
        ...
        fig_perf = go.Figure()
        for metric, vals, color in zip(['Precision','Recall','F1-Score'],
                                        [precision, recall, f1],
        ...
        fig_perf.update_layout(
            ...
            yaxis=dict(gridcolor=PLOT_GRID, range=[0,1.1], title='Score'),
        ...
        cm_data = [[2065, 18, 2], [128, 1848, 124], [6, 37, 2021]]
...
with tab3:
    ...
    <b style="color:#f9ca24">3. Feature Selection</b> — SelectKBest with chi² selects top features<br>
    <b style="color:#f9ca24">4. Balancing</b> — SMOTE oversamples minority classes to 10,415 each<br>
    <b style="color:#f9ca24">5. Training</b> — Random Forest · 500 trees · class weights {Fatal:10, Serious:5, Slight:1}<br>
    <b style="color:#f9ca24">6. Threshold Adjustment</b> — Custom thresholds correct for 84.5% class imbalance<br>
    <b style="color:#f9ca24">7. Deployment</b> — Streamlit app with joblib-saved pipeline artifacts
    </p>
